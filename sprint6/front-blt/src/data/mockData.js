...
export const MOCK_PRODUCTS = [
  {
    ...
    description: 'Fully functional vintage record player from the 1970s. Great condition with minor wear.',
    price: 120,
  ...
  },
  {
    ...
    description: 'Brown leather sofa in excellent condition. Only 6 months old. Moving and need to sell quickly.',
    price: 450,
    location: 'Austin, TX',
    category: 'Furniture',
    images: [
  ...
  },
  {
    ...
    description: 'Trek mountain bike in good condition. Recently tuned up with new brakes and tires.',
    price: 350,
    location: 'Denver, CO',
  ...
  },
  {
    ...
    description: 'iPhone 13 Pro in excellent condition. Includes original box, charger, and case.',
    price: 800,
  ...
  },
  {
    ...
    description: 'Solid wood dining table with 4 matching chairs. Perfect for a small apartment.',
    price: 280,
    location: 'Chicago, IL',
    category: 'Furniture',
    images: [
  ...
  },
  {
    ...
    description: 'Professional DSLR camera in excellent condition. Includes 24-70mm lens and carrying case.',
    price: 1200,
  ...
  },
  {
    ...
    description: 'Taylor acoustic guitar with hardshell case. Beautiful sound and well maintained.',
    price: 650,
  ...
  },
  {
    ...
    description: 'Beautiful antique writing desk from the 1920s. Solid oak with intricate detailing.',
    price: 300,
