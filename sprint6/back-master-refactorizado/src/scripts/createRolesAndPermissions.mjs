...
const initialPermissions = [
    ...
    { name: 'read:products', description: 'Puede ver superhéroes' },
    { name: 'create:products', description: 'Puede crear superhéroes' },
    { name: 'update:products', description: 'Puede actualizar superhéroes' },
    { name: 'delete:products', description: 'Puede eliminar superhéroes' }
];
...
const initialRoles = [
    ...
    },
    {
        ...
        permissions: ['read:superheros', 'create:superheros', 'update:superheros', 'read:products', 'create:products', 'update:products'],
    },
    {
        name: 'admin',
        description: 'Administrador del sistema',
        permissions: ['read:superheros', 'create:superheros', 'update:superheros', 'delete:superheros', 'read:products', 'create:products', 'update:products', 'delete:products'],
    },
];
